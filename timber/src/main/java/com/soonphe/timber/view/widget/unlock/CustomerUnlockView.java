...
public class CustomerUnlockView extends View {
    ...
    private void initView() {
        ...
        roadBitmap = ImageUtils.getBitmap(R.mipmap.lock_bg_road,screenWidth >> 1,screenHeight >> 1);
        leftBitmap = ImageUtils.getBitmap(R.mipmap.lock_key,screenWidth >> 1,screenHeight >> 1);
        rightBitmap = ImageUtils.getBitmap(R.mipmap.lock_unlock,screenWidth >> 1,screenHeight >> 1);
