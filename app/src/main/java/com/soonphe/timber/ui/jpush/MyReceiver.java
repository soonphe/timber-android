//package com.soonphe.timber.ui.jpush;
//
...
//            LogUtils.d( "[MyReceiver] onReceive接受到的通知或消息 - " + intent.getAction() + ", extras: " + printBundle(bundle));
//
...
//        LogUtils.e("--发送消息send msg to MainActivity");
//        if (MainActivity.isForeground) {
//            String message = bundle.getString(JPushInterface.EXTRA_MESSAGE);
//            String extras = bundle.getString(JPushInterface.EXTRA_EXTRA);
//            //这里将消息转发给MainActivity的Receiver
